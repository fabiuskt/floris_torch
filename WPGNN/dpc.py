...
load_path = save_model_path+'/{0:05d}'.format(1200)+'/wpgnn.h5'
model = WPGNN(eN=eN, nN=nN, gN=gN,graph_size=graph_size, model_path=load_path)

numWs, numWd, numLayout = 2,2,1
wsBatchSize, wdBatchSize, layoutBatchSize = 2, 2, 1
...
model.fitDPC(dataset_train, numWs, numWd, numLayout, 
          ...
          epochs=1200, decay_rate=0.99,print_every=10, save_every=100,
